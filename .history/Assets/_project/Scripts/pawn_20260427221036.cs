...
public class pawn : MonoBehaviour
{
    ...
    public IEnumerator MoveStep(Transform nextTile, int nextPos)
    {
        yield return StartCoroutine(MoveOneTile(nextTile.position, nextPos));
    }

    
    public IEnumerator MoveStep_blackHole(Transform nextTile, int nextPos)
    {
        yield return StartCoroutine(ShrinkThenMove(nextTile, nextPos));
    }

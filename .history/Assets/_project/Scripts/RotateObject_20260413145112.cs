    ...
    public int getFace()
{
    ...
    {
        (transform.up, 4),         // جهت بالای تاس (محلی)
        (-transform.up, 1),        // جهت پایین تاس
        (transform.right, 5),      // جهت راست تاس
        (-transform.right, 2),     // جهت چپ تاس
        (transform.forward, 6),    // جهت جلوی تاس
        (-transform.forward, 3)    // جهت عقب تاس
    };

...
public class player : MonoBehaviour
{
    ...
    private void MovePawn()
    {
        ...
        if (target_reassign % 10 == 6){target_reassign=target_reassign + 3;}
        if (target_reassign % 10 == 9){target_reassign=target_reassign -4;}
        if (target_reassign % 10 == 8){target_reassign=target_reassign-3;}

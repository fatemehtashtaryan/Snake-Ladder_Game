...
public class boardgame : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(string.Join(" ** ", specials.ConvertAll(s => s.Item1)));
        Debug.Log(string.Join(" # ", specials.ConvertAll(s => s.Item2)));
    }
    ...
    {
        int j = GetUniqueRandomIndex(6, 0);
        ...
        GameObject SpawnSnake = Instantiate(SnakePrefab, tailTile.GetElementSpawnTransform());
    ...
    private void SpawnLadderRandom()
    {
        ...
        GameObject SpawnLadder = Instantiate(LadderPrefab, tailTile.GetElementSpawnTransform());
        LadderConfig config = SpawnLadder.transform.GetComponent<SnakeConfig>();

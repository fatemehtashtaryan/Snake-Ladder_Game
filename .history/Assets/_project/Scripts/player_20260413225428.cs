...
public class player : MonoBehaviour
{
    ...
    private void MovePawn()
    {
        ...
        if (target_reassign % 10 == 6){target_reassign=target_reassign + 3;Debug.Log("3333 " +target_reassign);}
        if (target_reassign % 10 == 9){target_reassign=target_reassign -4;Debug.Log("--4444 " +target_reassign);}
        if (target_reassign % 10 == 8){target_reassign=target_reassign-3;Debug.Log("++4444 " +target_reassign);}

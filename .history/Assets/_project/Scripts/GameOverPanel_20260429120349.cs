...
public class GameOverPanel : MonoBehaviour
{
    ...
    {
        gameOverText. SetText($"Winner Is: Player{winnerIndex}");
    }
    ...
    IEnumerator AnimateImage()
    {
        ...
        yield return MoveUI(targetImage, new Vector2(startPos.x, -400), 0.8f);

        yield return MoveUI(targetImage, new Vector2(startPos.x, 0), 0.25f);
    }

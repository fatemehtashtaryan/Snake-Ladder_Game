...
public class boardgame : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SpawnSnakeRandom(4, 6, SnakePrefab_2);
        SpawnSnakeRandom(5, 6, SnakePrefab_4);
        SpawnSnakeRandom(5, 11, SnakePrefab_3);
    ...
    private void SpawnSnakeRandom(int coeff, int minus, GameObject SnakePrefab)
    {
        int head;

        do{
            int j = GetUniqueRandomIndex(2, 10, 0);

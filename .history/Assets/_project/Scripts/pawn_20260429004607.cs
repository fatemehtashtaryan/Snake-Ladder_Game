...
public class pawn : MonoBehaviour
{
    ...
    {
        StartCoroutine(MoveOneTile(nextTile.GetComponent<RectTransform>().anchoredPosition, nextPos));
    }
    ...
    private IEnumerator ShrinkThenMove(Transform nextTile, int targetIndex)
    {
        ...
        yield return StartCoroutine(MoveOneTile(nextTile.GetComponent<RectTransform>().anchoredPosition, targetIndex));

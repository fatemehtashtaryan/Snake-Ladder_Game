...
public class player : MonoBehaviour
{
    ...
    private void MovePawn()
    {
        ...
        if (target_reassign % 10 == 5){target_reassign=target_reassign + 4;Debug.Log(target_reassign);}
        if (target_reassign % 10 == 6){target_reassign=target_reassign + 3;Debug.Log(target_reassign);}
        if (target_reassign % 10 == 9){target_reassign=target_reassign -4;Debug.Log(target_reassign);}
        if (target_reassign % 10 == 8){target_reassign=target_reassign-3;Debug.Log(target_reassign);}

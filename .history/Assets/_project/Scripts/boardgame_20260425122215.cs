...
public class boardgame : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SpawnSnakeRandom(1, 2, 5, 0.5, 4, SnakePrefab_2);
        SpawnSnakeRandom(2, 2, 5, 1, 6, SnakePrefab_4);
        SpawnSnakeRandom(2, 3, 5, 1, 11, SnakePrefab_3);
    ...
    private void SpawnSnakeRandom(int firstRange_i, int firstRange_j, int coeff_j, float coeff_i, int minus, GameObject SnakePrefab)
    {
        int head;

...
public class player : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // if (star == null)
        //     Debug.LogError("STAR LIST IS NULL !");
        // else
        //     Debug.Log("star count: " + star.Count);
    ...
    IEnumerator MovePawnSteps()
    {
        ...
        StartCoroutine(checkTile_situation(current));
        ...
        if(CheckForHit()){
            ...
            CheckForHit();
            yield return new WaitForSeconds(0.4f);
            StartCoroutine(checkTile_situation(Pawn.GetPos()));
        }
    ...
    private IEnumerator checkTile_situation(int targetPos)
    {
        ...
        // }
        if (star == null) {start = Board.get_star();}    // یعنی هنوز Start اجرا نشده
